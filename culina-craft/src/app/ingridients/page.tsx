    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex flex-col md:flex-row flex-grow px-6 md:px-12 py-6 gap-8">
        ...
        <aside className="w-full md:w-[510px] bg-[#F7D197] p-4 rounded-lg flex flex-col h-[400px]">
          ...
          <div className="mb-4">
            <SearchBar placeholder="What ingredients you have?" className="md:w-[480px]" />
          </div>

          {/* Daftar bahan dengan scrolling */}
          <div className="overflow-y-auto flex-grow space-y-3 pr-3">
        ...
        <section className="flex-1">
          ...
          <div className="flex items-center justify-start gap-4 my-4">
            {/* Chicken Button */}
            <div className="flex items-center bg-white border border-black px-3 py-1 rounded-full text-black 
            ...
            {/* Clear All Button */}
            <button className="text-[#dd6840] border border-[#dd6840] px-3 py-1 rounded-full text-sm 
          ...
          {/* Grid Resep */}
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-auto gap-6 justify-center w-full">
